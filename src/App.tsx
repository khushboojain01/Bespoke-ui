...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50" onClick={() => setStatusDropdownOpen(false)}>
      {/* Header */}
      <header 
        className="bg-white border-b border-gray-200 px-4 md:px-6 py-4 relative"
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="relative">
              <button
                ...
                className={`text-sm font-medium text-${getStatusColor(status)}-700 flex items-center cursor-pointer transition-colors rounded px-2 py-1`}
              >
            ...
            <div className="flex items-center space-x-2">
              ...
              <button className="flex items-center space-x-1 px-3 py-1.5 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-sm">
